...
import CharliePuthImg from "../images/charliePuth.jpeg";
...
export const CharliePuth = {
  playListImg: CharliePuthImg,
  playListName: "Charlie PuthImg",
  musciList: [
    {
      id: 1,
      name: "How Long",
      artists: "Charlie PuthImg",
      time: 330,
    ...
    },
    {
      ...
      artists: "Charlie PuthImg",
      time: 350,
      src: "https://www.youtube.com/watch?v=3AtDnEC4zak"
    },
    {
      id: 3,
      name: "One Call Away",
      artists: "Charlie PuthImg",
      time: 361,
      src: "https://www.youtube.com/watch?v=BxuY9FET9Y4"
    },
    {
      id: 4,
      name: "Marvin Gaye ft. Meghan Trainor",
      artists: "Charlie PuthImg",
      time: 328,
      src:
        "https://www.youtube.com/watch?v=igNVdlXhKcI&index=7&list=RDBxuY9FET9Y4"
    },
    {
      id: 5,
    ...
    },
    {
      ...
      time: 322,
      src:
        "https://www.youtube.com/watch?v=TBXQu8ORnBQ&index=5&list=RDBxuY9FET9Y4"
    }
  ]
};
